...
class MyItemListener implements ItemListener{
	private String right = "d:" + File.separator + "Java" + File.separator + "icons" + File.separator + "right.png" ;
	private String wrong = "d:" + File.separator + "Java" + File.separator + "icons" + File.separator + "wrong.gif" ;
